...
export default function Main1(){
    ...
    <Col xs={6} md={6} sm={7}> {/* This will make the input full-width on extra small screens and half-width on medium screens */}
            <FormControl type="email" placeholder="Enter email" id="input1" className="mb-3" />

            <FormControl type="password" id="input2" placeholder="password" className="form-control mb-3"  />
